...
<section id="secTopArticle" class="row">
	<article id="topArticle" class="col-xs-12 col-md-push-2 col-md-8">
		...
		<form action="Panier/panier" method="post" class="formTopArticle col-xs-3">
			<fieldset class="col-xs-12 p0">
				...
				<input class="btn btn-success" id="sub" type="submit" value="Ajouter au panier"/>
			</fieldset>
		</form>
	</article>
</section>
